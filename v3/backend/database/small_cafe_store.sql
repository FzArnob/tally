...
--
-- HOW TO RUN
--   mysql -u root -p tally_v3 < dummy_data.sql   (or paste into phpMyAdmin's SQL tab)
--
...
-- MATERIALS (raw stock)
-- ===========================================================================
INSERT INTO materials (book_id, name, quantity_type, image_url) VALUES
  (@book, 'Coffee Beans', 'kg',    'https://loremflickr.com/320/320/coffee,beans?lock=101');
SET @m_beans := LAST_INSERT_ID();
INSERT INTO materials (book_id, name, quantity_type, image_url) VALUES
  (@book, 'Coffee Cups', 'piece',  'https://loremflickr.com/320/320/coffee,cup?lock=102');
SET @m_cups := LAST_INSERT_ID();
INSERT INTO materials (book_id, name, quantity_type, image_url) VALUES
  (@book, 'Milk', 'liter',         'https://loremflickr.com/320/320/milk,bottle?lock=103');
SET @m_milk := LAST_INSERT_ID();
INSERT INTO materials (book_id, name, quantity_type, image_url) VALUES
  (@book, 'Cream', 'liter',        'https://loremflickr.com/320/320/cream,dairy?lock=104');
SET @m_cream := LAST_INSERT_ID();
INSERT INTO materials (book_id, name, quantity_type, image_url) VALUES
  (@book, 'Coffee Machine', 'piece','https://loremflickr.com/320/320/espresso,machine?lock=105');
SET @m_machine := LAST_INSERT_ID();
INSERT INTO materials (book_id, name, quantity_type, image_url) VALUES
  (@book, 'Bun', 'piece',          'https://loremflickr.com/320/320/burger,bun?lock=106');
SET @m_bun := LAST_INSERT_ID();
INSERT INTO materials (book_id, name, quantity_type, image_url) VALUES
  (@book, 'Beef', 'kg',            'https://loremflickr.com/320/320/raw,beef?lock=107');
SET @m_beef := LAST_INSERT_ID();
INSERT INTO materials (book_id, name, quantity_type, image_url) VALUES
  (@book, 'Chicken', 'kg',         'https://loremflickr.com/320/320/raw,chicken?lock=108');
SET @m_chicken := LAST_INSERT_ID();

-- Material moves: initial stock-ins, plus a couple of 'used' (consumption) entries.
INSERT INTO material_transactions (material_id, book_id, type, quantity, price_per_unit, total_amount, stock_after, note, created_at) VALUES
  (@m_beans,   @book, 'stock', 25,  1800.00, 45000.00, 25,  'Single-origin arabica', DATE_SUB(UTC_TIMESTAMP(), INTERVAL 40 DAY)),
  (@m_beans,   @book, 'used',  5,      0.00,     0.00, 20,  'Brew consumption',       DATE_SUB(UTC_TIMESTAMP(), INTERVAL 8 DAY)),
  (@m_cups,    @book, 'stock', 500,   12.00,  6000.00, 500, 'Branded cups',           DATE_SUB(UTC_TIMESTAMP(), INTERVAL 39 DAY)),
  (@m_milk,    @book, 'stock', 60,    90.00,  5400.00, 60,  'Fresh full-cream',       DATE_SUB(UTC_TIMESTAMP(), INTERVAL 38 DAY)),
  (@m_milk,    @book, 'used',  12,     0.00,     0.00, 48,  'Steaming & lattes',      DATE_SUB(UTC_TIMESTAMP(), INTERVAL 6 DAY)),
  (@m_cream,   @book, 'stock', 20,   350.00,  7000.00, 20,  'Whipping cream',         DATE_SUB(UTC_TIMESTAMP(), INTERVAL 37 DAY)),
  (@m_machine, @book, 'stock', 2, 250000.00,500000.00, 2,   'La Marzocco units',      DATE_SUB(UTC_TIMESTAMP(), INTERVAL 60 DAY)),
  (@m_bun,     @book, 'stock', 200,   25.00,  5000.00, 200, 'Brioche buns',           DATE_SUB(UTC_TIMESTAMP(), INTERVAL 12 DAY)),
  (@m_beef,    @book, 'stock', 30,   950.00, 28500.00, 30,  'Premium cuts',           DATE_SUB(UTC_TIMESTAMP(), INTERVAL 11 DAY)),
  (@m_chicken, @book, 'stock', 40,   320.00, 12800.00, 40,  'Free-range',             DATE_SUB(UTC_TIMESTAMP(), INTERVAL 11 DAY));

-- ===========================================================================
-- PRODUCTS — manufacture (linked to materials, sale-only)
-- ===========================================================================
INSERT INTO products (book_id, name, quantity_type, product_type, image_url) VALUES
  (@book, 'Signature Espresso', 'piece', 'manufacture', 'https://loremflickr.com/320/320/espresso?lock=201');
SET @p_espresso := LAST_INSERT_ID();
INSERT INTO products (book_id, name, quantity_type, product_type, image_url) VALUES
  (@book, 'Cappuccino', 'piece', 'manufacture', 'https://loremflickr.com/320/320/cappuccino?lock=202');
SET @p_cappuccino := LAST_INSERT_ID();
INSERT INTO products (book_id, name, quantity_type, product_type, image_url) VALUES
  (@book, 'Caffe Latte', 'piece', 'manufacture', 'https://loremflickr.com/320/320/latte?lock=203');
SET @p_latte := LAST_INSERT_ID();
INSERT INTO products (book_id, name, quantity_type, product_type, image_url) VALUES
  (@book, 'Cold Brew', 'piece', 'manufacture', 'https://loremflickr.com/320/320/cold,brew,coffee?lock=204');
SET @p_coldbrew := LAST_INSERT_ID();
INSERT INTO products (book_id, name, quantity_type, product_type, image_url) VALUES
  (@book, 'Wagyu Beef Burger', 'piece', 'manufacture', 'https://loremflickr.com/320/320/gourmet,burger?lock=205');
SET @p_burger := LAST_INSERT_ID();
INSERT INTO products (book_id, name, quantity_type, product_type, image_url) VALUES
  (@book, 'Grilled Chicken Sandwich', 'piece', 'manufacture', 'https://loremflickr.com/320/320/chicken,sandwich?lock=206');
SET @p_sandwich := LAST_INSERT_ID();
INSERT INTO products (book_id, name, quantity_type, product_type, image_url) VALUES
  (@book, 'Truffle Cream Latte', 'piece', 'manufacture', 'https://loremflickr.com/320/320/latte,art?lock=207');
SET @p_trufflelatte := LAST_INSERT_ID();

-- PRODUCTS — ready-made (bought & resold)
INSERT INTO products (book_id, name, quantity_type, product_type, image_url) VALUES
  (@book, 'Artisan Biscuit', 'packet', 'ready_made', 'https://loremflickr.com/320/320/biscuit,cookie?lock=208');
SET @p_biscuit := LAST_INSERT_ID();
INSERT INTO products (book_id, name, quantity_type, product_type, image_url) VALUES
  (@book, 'Fresh Coffee Beans', 'packet', 'ready_made', 'https://loremflickr.com/320/320/coffee,beans,bag?lock=209');
SET @p_beansbag := LAST_INSERT_ID();
INSERT INTO products (book_id, name, quantity_type, product_type, image_url) VALUES
  (@book, 'Dessert Jar', 'piece', 'ready_made', 'https://loremflickr.com/320/320/dessert,tiramisu?lock=210');
SET @p_dessert := LAST_INSERT_ID();
...
INSERT INTO product_transactions (product_id, book_id, type, quantity, price_per_unit, total_amount, stock_after, note, created_at) VALUES
  (@p_espresso, @book, 'sale', 25, 320.00,  8000.00, NULL, NULL, DATE_SUB(UTC_TIMESTAMP(), INTERVAL 20 DAY)),
  (@p_espresso, @book, 'sale', 30, 320.00,  9600.00, NULL, NULL, DATE_SUB(UTC_TIMESTAMP(), INTERVAL 12 DAY)),
  (@p_espresso, @book, 'sale', 22, 320.00,  7040.00, NULL, NULL, DATE_SUB(UTC_TIMESTAMP(), INTERVAL 5 DAY)),
  (@p_espresso, @book, 'sale', 28, 320.00,  8960.00, NULL, NULL, DATE_SUB(UTC_TIMESTAMP(), INTERVAL 1 DAY)),

  (@p_cappuccino, @book, 'sale', 20, 420.00, 8400.00, NULL, NULL, DATE_SUB(UTC_TIMESTAMP(), INTERVAL 18 DAY)),
  (@p_cappuccino, @book, 'sale', 24, 420.00, 10080.00, NULL, NULL, DATE_SUB(UTC_TIMESTAMP(), INTERVAL 9 DAY)),
  (@p_cappuccino, @book, 'sale', 18, 420.00, 7560.00, NULL, NULL, DATE_SUB(UTC_TIMESTAMP(), INTERVAL 2 DAY)),

  (@p_latte, @book, 'sale', 26, 450.00, 11700.00, NULL, NULL, DATE_SUB(UTC_TIMESTAMP(), INTERVAL 19 DAY)),
  (@p_latte, @book, 'sale', 19, 450.00, 8550.00, NULL, NULL, DATE_SUB(UTC_TIMESTAMP(), INTERVAL 11 DAY)),
  (@p_latte, @book, 'sale', 23, 450.00, 10350.00, NULL, NULL, DATE_SUB(UTC_TIMESTAMP(), INTERVAL 4 DAY)),
  (@p_latte, @book, 'sale', 21, 450.00, 9450.00, NULL, NULL, DATE_SUB(UTC_TIMESTAMP(), INTERVAL 1 DAY)),

  (@p_coldbrew, @book, 'sale', 15, 480.00, 7200.00, NULL, NULL, DATE_SUB(UTC_TIMESTAMP(), INTERVAL 16 DAY)),
  (@p_coldbrew, @book, 'sale', 12, 480.00, 5760.00, NULL, NULL, DATE_SUB(UTC_TIMESTAMP(), INTERVAL 7 DAY)),
  (@p_coldbrew, @book, 'sale', 18, 480.00, 8640.00, NULL, NULL, DATE_SUB(UTC_TIMESTAMP(), INTERVAL 3 DAY)),

  (@p_burger, @book, 'sale', 8,  950.00, 7600.00, NULL, NULL, DATE_SUB(UTC_TIMESTAMP(), INTERVAL 10 DAY)),
  (@p_burger, @book, 'sale', 11, 950.00, 10450.00, NULL, NULL, DATE_SUB(UTC_TIMESTAMP(), INTERVAL 5 DAY)),
  (@p_burger, @book, 'sale', 9,  950.00, 8550.00, NULL, NULL, DATE_SUB(UTC_TIMESTAMP(), INTERVAL 2 DAY)),

  (@p_sandwich, @book, 'sale', 14, 650.00, 9100.00, NULL, NULL, DATE_SUB(UTC_TIMESTAMP(), INTERVAL 9 DAY)),
  (@p_sandwich, @book, 'sale', 10, 650.00, 6500.00, NULL, NULL, DATE_SUB(UTC_TIMESTAMP(), INTERVAL 4 DAY)),
  (@p_sandwich, @book, 'sale', 12, 650.00, 7800.00, NULL, NULL, DATE_SUB(UTC_TIMESTAMP(), INTERVAL 1 DAY)),

  (@p_trufflelatte, @book, 'sale', 9,  620.00, 5580.00, NULL, NULL, DATE_SUB(UTC_TIMESTAMP(), INTERVAL 6 DAY)),
  (@p_trufflelatte, @book, 'sale', 13, 620.00, 8060.00, NULL, NULL, DATE_SUB(UTC_TIMESTAMP(), INTERVAL 2 DAY));

-- ---- Ready-made moves (running stock_after authored inline) ----
INSERT INTO product_transactions (product_id, book_id, type, quantity, price_per_unit, total_amount, stock_after, note, created_at) VALUES
  (@p_biscuit, @book, 'stock', 100, 120.00, 12000.00, 100, 'Initial stock',  DATE_SUB(UTC_TIMESTAMP(), INTERVAL 25 DAY)),
  (@p_biscuit, @book, 'sale',  12,  180.00,  2160.00, 88,  NULL,             DATE_SUB(UTC_TIMESTAMP(), INTERVAL 18 DAY)),
  (@p_biscuit, @book, 'sale',  18,  180.00,  3240.00, 70,  NULL,             DATE_SUB(UTC_TIMESTAMP(), INTERVAL 12 DAY)),
  (@p_biscuit, @book, 'stock', 50,  120.00,  6000.00, 120, 'Restock',        DATE_SUB(UTC_TIMESTAMP(), INTERVAL 6 DAY)),
  (@p_biscuit, @book, 'sale',  20,  180.00,  3600.00, 100, NULL,             DATE_SUB(UTC_TIMESTAMP(), INTERVAL 2 DAY)),

  (@p_beansbag, @book, 'stock', 80, 1200.00, 96000.00, 80, 'Retail bags',    DATE_SUB(UTC_TIMESTAMP(), INTERVAL 22 DAY)),
  (@p_beansbag, @book, 'sale',  10, 1600.00, 16000.00, 70, NULL,             DATE_SUB(UTC_TIMESTAMP(), INTERVAL 10 DAY)),
  (@p_beansbag, @book, 'sale',  8,  1600.00, 12800.00, 62, NULL,             DATE_SUB(UTC_TIMESTAMP(), INTERVAL 3 DAY)),

  (@p_dessert, @book, 'stock', 60, 250.00, 15000.00, 60, 'Tiramisu jars',    DATE_SUB(UTC_TIMESTAMP(), INTERVAL 15 DAY)),
  (@p_dessert, @book, 'sale',  9,  380.00,  3420.00, 51, NULL,               DATE_SUB(UTC_TIMESTAMP(), INTERVAL 9 DAY)),
  (@p_dessert, @book, 'sale',  14, 380.00,  5320.00, 37, NULL,               DATE_SUB(UTC_TIMESTAMP(), INTERVAL 4 DAY)),
  (@p_dessert, @book, 'sale',  7,  380.00,  2660.00, 30, NULL,               DATE_SUB(UTC_TIMESTAMP(), INTERVAL 1 DAY));
